...
We will now benchmark the model on a new site with very different configurations (no common parameters). Competitor turbines have also been included. The reference configuration is 
`r reference[,unique(as.character(reference$turbine))]`.
